...
export const updateJob = async (req, res) => {
    ...
    try {
        ...
        updatedJob.experienceLevel = experienceLevel ?? updatedJob.experienceLevel;
        updatedJob.position = position ?? updatedJob.position;
        updatedJob.company = company ?? updatedJob.company;
        updatedJob.applications = applications ?? updatedJob.applications;
